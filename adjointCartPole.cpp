...
//        }
        ...
        struct aug_dyn_ {
            ...
            operator() (
                ...
                std::cout << "Integrating at " << t << std::endl;
                std::vector<double> yt1;
                ...
                std::cout << "value from back dyn: " << fVal[0] << ", " << fVal[1] << ", " << fVal[2] << std::endl;
        ...
        std::vector<double> cartpole_forward(
                const std::vector<double>& y0,
                const std::vector<double>& theta0,
                const double& t0,
                const double& t1
        ) {
            cartpole_sys::cartpole_dyn dyn;
        ...
        std::vector<var> cartpole_forward(
            ...
            const cartpole_sys::cartpole_dyn dyn;
            const cartpole_sys::cartpole_dyn_back dyn_back;
            const aug_dyn_<cartpole_sys::cartpole_dyn_back> aug_dyn(dyn_back, theta0.size(), y0.size(), t1Val);


            // y(t1)
            std::vector<double> yt1 = cartpole_forward(y0Val, theta0Val, t0Val, t1Val);
            ...
            std::cout << "Computed Value of y(t0): " << yt1_temp[0] << ", " << yt1_temp[1] << ", " << yt1_temp[2] << std::endl;
...
int main() {
    ...
    std::vector<stan::math::var> y1 = stan::math::cartpole_forward(y0, theta0, t0, t1);
    ...
    cartpole_sys::cartpole_dyn dyn;
    numerical_jacobian(dyn, value_of(y0), t0.val(), t1.val(), value_of(theta0), 0.001);
    std::cout << std::endl;
